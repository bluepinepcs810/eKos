...
const ProductList = () => {
  const { state: { activeFilterSection }} = useContext(ProductFilterContext);

  return (
    <div className="product-list bg-main pt-8 flex justify-center relative">
      <div className={"absolute top-0 transition " + (activeFilterSection !== ProductFilterSections.NONE ? 'overlay w-full h-full ': '')}></div>
