...
const FilterItemConditionMenu = () => {
  ...
  const handleClick = useCallback(() => {
    dispatch({ type: ProductFilterActionTypes.SET_SECTION, payload: ProductFilterSections.ITEM_CONDITION});
  }, [dispatch]);
  ...
  const handleApply = useCallback(() => {
    dispatch({ type: ProductFilterActionTypes.SET_FILTER_ITEM_CONDITION, payload: conditions})
    dispatch({ type: ProductFilterActionTypes.SET_SECTION, payload: ProductFilterSections.NONE});
  }, [conditions, dispatch])

  return (
    <div className={"filter-item-condition-menu relative group " + (activeFilterSection === ProductFilterSections.ITEM_CONDITION ? 'active' : '')}>
