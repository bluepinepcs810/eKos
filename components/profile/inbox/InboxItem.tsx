...
const InboxItem = () => {
  return (
    ...
    >
        ...
        <div className="flex flex-col flex-1">
          ...
          <div className="text-[12px] flex-grow flex items-center">
            <div className="message-truncated">
              Good afternoon, can I ask for more pictures of your product, also I have been buying things from you for a long time,
              is there a discount?
            </div>
          </div>
        </div>
      ...
      <div>
        <div className="text-main-weighted text-[12px] font-normal pr-1">Yesterday</div>
      </div>
    </Link>
  )
}
