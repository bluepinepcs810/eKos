        ...
        <div className="flex items-center mr-2">
          <button>
            <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fillRule="evenodd" clipRule="evenodd" d="M0.43949 0.43934C-0.146297 1.02513 -0.146297 1.97487 0.43949 2.56066L8.37883 10.5L0.43949 18.4393C-0.146297 19.0251 -0.146297 19.9749 0.43949 20.5607C1.02528 21.1464 1.97502 21.1464 2.56081 20.5607L10.8537 12.2678C11.83 11.2915 11.83 9.70855 10.8537 8.73223L2.56081 0.43934C1.97502 -0.146447 1.02528 -0.146447 0.43949 0.43934Z" fill="#5E25D9"/>
              <path fillRule="evenodd" clipRule="evenodd" d="M20.5605 0.43934C21.1463 1.02513 21.1463 1.97487 20.5605 2.56066L12.6212 10.5L20.5605 18.4393C21.1463 19.0251 21.1463 19.9749 20.5605 20.5607C19.9747 21.1464 19.025 21.1464 18.4392 20.5607L10.1463 12.2678C9.16999 11.2915 9.16998 9.70855 10.1463 8.73223L18.4392 0.43934C19.025 -0.146447 19.9747 -0.146447 20.5605 0.43934Z" fill="#5E25D9"/>
            </svg>
          </button>
        </div>
      </div>
