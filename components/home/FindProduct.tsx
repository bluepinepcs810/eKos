  ...
  return (
    <section className="find-product bg-main-light min-h-[374px] flex justify-center items-center">
      <div className="content-container">
        <h2 className="text-[28px] font-semibold text-center text-main-thick mb-5">Find a product near me</h2>
        <div className="search-city flex justify-center items-center gap-x-1 mb-7">
          <input className="search-city-input w-[300px] py-2 px-5 rounded-full border border-main-thick" placeholder="Find your city" />
