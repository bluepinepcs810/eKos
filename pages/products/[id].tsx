          ...
          <div className="product-detail__card__body px-14">
            ...
            <div className="product-detail__card__info mt-10">
              <div className="product-detail__card__info--price mb-2">
                <div className="flex items-center gap-x-2">
                  <svg width="32" height="27" viewBox="0 0 32 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4.83007 0.228905C4.92215 0.0862047 5.08037 0 5.2502 0H31.0823C31.4783 0 31.7171 0.438381 31.5024 0.771095L27.1699 7.48538C27.0778 7.62808 26.9196 7.71429 26.7498 7.71429H0.91769C0.521724 7.71429 0.282873 7.27591 0.497562 6.94319L4.83007 0.228905Z" fill="#4703A6"/>
                    <path d="M27.1699 9.87182C27.0778 9.72912 26.9196 9.64291 26.7498 9.64291H0.91769C0.521723 9.64291 0.282873 10.0813 0.497561 10.414L4.83007 17.1283C4.92215 17.271 5.08037 17.3572 5.2502 17.3572H31.0823C31.4783 17.3572 31.7171 16.9188 31.5024 16.5861L27.1699 9.87182Z" fill="#4703A6"/>
                    <path d="M4.83007 19.5146C4.92215 19.3719 5.08037 19.2857 5.2502 19.2857H31.0823C31.4783 19.2857 31.7171 19.7241 31.5024 20.0568L27.1699 26.7711C27.0778 26.9138 26.9196 27 26.7498 27H0.91769C0.521724 27 0.282873 26.5616 0.497562 26.2289L4.83007 19.5146Z" fill="#4703A6"/>
                  </svg>
              ...
              <div className="product-detail__card__info--name mb-12">
                <h1 className="text-3xl font-semibold text-main-dark">Your product name</h1>
              </div>
              ...
              <div className="product-detail__card__info--category flex mb-4">
                ...
                <div className="category-tag bg-main-dark rounded-full flex justify-center  px-4 py-1 gap-x-2">
                  <CategoryFashionHoverIcon width="15" height="14" viewBox="0 0 45 42" className="mt-1" />
              ...
              <div className="product-detail__card__info--description mt-4 mb-4">
                ...
                A description of your product that reveals its history and adds information about the product. Basic information we need to know
                </p>
              </div>
              ...
              <div className="product-detail__card__info--date mt-4 mb-4 flex justify-between items-center">
                <div className="text-second-main">
                  12-SEP-2022
                </div>
                <div className="flex gap-x-3">
                  <div className="view-count flex gap-x-2 items-center">
                    <svg width="26" height="19" viewBox="0 0 26 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M13 2.53333C17.4791 2.53333 21.4736 5.23133 23.4236 9.5C21.4736 13.7687 17.4909 16.4667 13 16.4667C8.50909 16.4667 4.52636 13.7687 2.57636 9.5C4.52636 5.23133 8.52091 2.53333 13 2.53333ZM13 0C7.09091 0 2.04455 3.93933 0 9.5C2.04455 15.0607 7.09091 19 13 19C18.9091 19 23.9555 15.0607 26 9.5C23.9555 3.93933 18.9091 0 13 0ZM13 6.33333C14.6309 6.33333 15.9545 7.752 15.9545 9.5C15.9545 11.248 14.6309 12.6667 13 12.6667C11.3691 12.6667 10.0455 11.248 10.0455 9.5C10.0455 7.752 11.3691 6.33333 13 6.33333ZM13 3.8C10.0691 3.8 7.68182 6.35867 7.68182 9.5C7.68182 12.6413 10.0691 15.2 13 15.2C15.9309 15.2 18.3182 12.6413 18.3182 9.5C18.3182 6.35867 15.9309 3.8 13 3.8Z" fill="#B79ADD"/>
                    </svg>
              ...
              <div className="product-detail__card__info--location mt-4 mb-4">
                <div className="flex gap-x-2 mb-8">
                  <svg width="18" height="25" viewBox="0 0 18 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" clipRule="evenodd" d="M0 8.75C0 3.9125 4.02429 0 9 0C13.9757 0 18 3.9125 18 8.75C18 15.3125 9 25 9 25C9 25 0 15.3125 0 8.75ZM9 2.5C5.45143 2.5 2.57143 5.3 2.57143 8.75C2.57143 12.3125 6.32571 17.7625 9 21.1C11.7257 17.7375 15.4286 12.35 15.4286 8.75C15.4286 5.3 12.5486 2.5 9 2.5ZM12.2145 8.75007C12.2145 10.476 10.7754 11.8751 9.00017 11.8751C7.22497 11.8751 5.78589 10.476 5.78589 8.75007C5.78589 7.02418 7.22497 5.62507 9.00017 5.62507C10.7754 5.62507 12.2145 7.02418 12.2145 8.75007Z" fill="#5E25D9"/>
                  </svg>
